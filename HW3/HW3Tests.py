...
class HW3SampleTests(unittest.TestCase):
    ...
    def test_2_merge_by_year(self):
        ...
        self.assertDictEqual(merge_by_year(self.emptylog), output)
    ...
    def test_2_merge_year(self):
        ...
        output = {}
        self.assertDictEqual(merge_year(self.emptylog, 2019), output)
    ...
    def test_2_getmax_of_flavor(self):
        ...
        # Provide your own test here. Create your own input dictionary for this test (similar to self.my_cats_log). 
        # You can re-use the data dictionary you created for merge_by_year test.
        self.assertTupleEqual(getmax_of_flavor(self.emptylog,"Beef"),output)
    #--- Problem 2(a)----------------------------------
    ...
    def test_2_follow_the_follower(self):
        ...
        output = []
        self.assertListEqual(follow_the_follower(self.emptygraph),output )
    ...
    def test_2_follow_the_follower2(self):
        ...
        output = []
        self.assertListEqual(follow_the_follower2(self.emptygraph),output )

    #--- Problem 3----------------------------------
    def test_1_connected(self):
        self.assertTrue(connected(self.graph, 'A' ,'F'))
        self.assertFalse(connected(self.graph, 'E' ,'A'))
        self.assertFalse(connected(self.graph, 'A' ,'H'))
        self.assertTrue(connected(self.graph, 'H' ,'E'))

    def test_2_connected(self):
        self.assertFalse(connected(self.emptygraph, 'A', 'F'))
        self.assertFalse(connected(self.emptygraph, 'E' ,'A'))
        # Provide your own test here. Create your own graph dictionary for this test (similar to self.graph). 
        # You can re-use the data dictionary you created for follow_the_follower test.
